...
in that revealing, allow calm \ldots{} as the heart is naturally revealed it, allow it to lift,
...
\ldots{} the shifting, changing experience to be noticed in its natural uncertainty and so
\ldots{} not taken so seriously, so personally -- and it's allowed to be as it is, and allowed
...
wheel of the cart pulled by an ox, those which are skilful give results as light as a
shadow.
...
are different from hope. We cam begin with a sense of `I can do this. If I
work with this, then this can happen' -- that gives us confidence. But with
...
Revelation is like: `What? I believed that for so long? I didn't see this', accompanied by a sense of calm and lack of conflict.
...
we can work it -- and there is not a way out of it through more thinking and beleiving in this.
...
\ldots{} instead give attention to the body -- the responses of the senses;
